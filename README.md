...
ProofOfStudy is a Base mini app for zero-cost or near-zero-cost learning rewards. A user connects a wallet, checks in once per UTC day, and immediately sees reward progress.
...
`84532` is Base Sepolia. Use `8453` for Base Mainnet after deploying a mainnet contract.
